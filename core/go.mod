module github.com/ladderairport/agent/android
...
require (
	...
	github.com/fatedier/frp v0.0.0-00010101000000-000000000000 // indirect
	...
	github.com/ladderairport/pkg v0.0.0 // indirect
